...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tensorflowonspark-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8642&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tensorflowonspark-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tensorflowonspark` can be installed with `conda`:
...
```
mamba install tensorflowonspark
```

It is possible to list all of the versions of `tensorflowonspark` available on your platform with `conda`:
...
```
mamba search tensorflowonspark --channel conda-forge
```
...
mamba repoquery search tensorflowonspark --channel conda-forge

# List packages depending on `tensorflowonspark`:
mamba repoquery whoneeds tensorflowonspark --channel conda-forge

# List dependencies of `tensorflowonspark`:
mamba repoquery depends tensorflowonspark --channel conda-forge
```
